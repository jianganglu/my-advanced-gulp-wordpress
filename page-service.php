...
<div class="banner">
  <div class="fixed-image section dark-translucent-bg">
    <div class="container">
      ...
      <p class="lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vitae sit excepturi,<br> 
hic officiis illo dolore sunt assumenda saepe id commodi sint praesentium<br>
            ...
            <div class="main col-md-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <img class="animated fadeInUpSmall" src="<?php bloginfo( 'template_url' ); ?>/assets/img/services-1.png" alt="iDea">
                    </div>
                </div>
                <div class="space"></div>
...
<div class="section gray-bg clearfix">
    <div class="container">
        ...
        <div class="row grid-space-10">
             <div class="col-sm-4">
                <div class="box-style-2 object-non-visible animated object-visible fadeInUpSmall" data-animation-effect="fadeInUpSmall" data-effect-delay="0">
                    <div class="icon-container default-bg">
            ...
            <div class="col-sm-4">
                <div class="box-style-2 object-non-visible animated object-visible fadeInUpSmall" data-animation-effect="fadeInUpSmall" data-effect-delay="200">
                    <div class="icon-container default-bg">
            ...
            <div class="col-sm-4">
                <div class="box-style-2 object-non-visible animated object-visible fadeInUpSmall" data-animation-effect="fadeInUpSmall" data-effect-delay="400">
                    <div class="icon-container default-bg">
        ...
        <div class="row grid-space-10">
            <div class="col-sm-4">
                <div class="box-style-2 object-non-visible animated object-visible fadeInUpSmall" data-animation-effect="fadeInUpSmall" data-effect-delay="600">
                    <div class="icon-container default-bg">
                        <i class="fa fa-bold"></i>
                    </div>
                    <div class="body">
            ...
            <div class="col-sm-4">
                <div class="box-style-2 object-non-visible animated object-visible fadeInUpSmall" data-animation-effect="fadeInUpSmall" data-effect-delay="800">
                    <div class="icon-container default-bg">
                        <i class="fa fa-check"></i>
                    </div>
                    <div class="body">
            ...
            <div class="col-sm-4">
                <div class="box-style-2 object-non-visible animated object-visible fadeInUpSmall" data-animation-effect="fadeInUpSmall" data-effect-delay="1000">
                    <div class="icon-container default-bg">
                        <i class="fa fa-bicycle"></i>
                    </div>
                    <div class="body">
    ...
    <div class="container">
        ...
        <div class="process">
            ...
            <ul class="nav nav-pills white space-top" role="tablist">
                <li class="active"><a href="#pill-1" role="tab" data-toggle="tab" title="Step 1" aria-expanded="true"><i class="fa fa-dot-circle-o pr-5"></i> Step 1</a></li>
                <li class=""><a href="#pill-2" role="tab" data-toggle="tab" title="Step 2" aria-expanded="false"><i class="fa fa-dot-circle-o pr-5"></i> Step 2</a></li>
                <li class=""><a href="#pill-3" role="tab" data-toggle="tab" title="Step 3" aria-expanded="false"><i class="fa fa-dot-circle-o pr-5"></i> Step 3</a></li>
            </ul>
            <!-- Tab panes -->
            <div class="tab-content clear-style">
                ...
                <div class="tab-pane" id="pill-2">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <img src="<?php bloginfo( 'template_url' ); ?>/assets/img/section-image-1.png" alt="">
                        </div>
                        <div class="col-md-6">
                            <p>Ipsum dolor sit amet, consectetur adipisicing elit. Sit, labore iste! Pariatur tempore, dicta voluptatibus quis blanditiis voluptates in. Molestiae asperiores sed, pariatur nesciunt saepe. Culpa ipsam ut enim reiciendis!</p>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ea sit enim sint deleniti saepe esse nisi nesciunt fuga eaque dicta tenetur, cupiditate illo, consequuntur unde dolores quis dolore rem ex asperiores error. Labore saepe beatae harum quod fuga ipsam! Iusto earum iste similique, quam esse rerum, quae atque inventore consequuntur voluptatum amet deserunt mollitia? Tempore fugit, cumque dolor eaque doloremque iusto nostrum excepturi unde! Similique ipsum fugit eius laboriosam nihil quos, quia et! Earum iure, sapiente. Molestiae unde earum fugiat voluptate incidunt.</p>
...
<div class="section clearfix">
    <div class="container">
        ...
        <div class="pricing-tables gray object-non-visible animated object-visible fadeInUpSmall" data-animation-effect="fadeInUpSmall">
...
<script src="<?php bloginfo( 'template_url' ); ?>/assets/js/service.js"></script>